            ...
            <div class="d-flex flex-sm-row flex-column gap-2">
                <div class="mb-3 flex-fill">
                    ...
                    <select class="form-select" id="companyFilter">
                        ...
                        @foreach($serviceProvidersList as $provider)
                            @if(isset($provider->serviceproviderprofile->company_name))
                                <option value="{{ $provider->serviceproviderprofile->company_name }}">{{ $provider->serviceproviderprofile->company_name }}</option>
                            @endif
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-3 flex-fill">
                    ...
                    <select class="form-select" id="contactNumberFilter">
                        <option value="" selected>All...</option>
                        @foreach($serviceProvidersList as $provider)
                            @if(isset($provider->serviceproviderprofile->contact_number))
                                <option value="{{ $provider->serviceproviderprofile->contact_number }}">{{ $provider->serviceproviderprofile->contact_number }}</option>
                            @endif
                        @endforeach
                    </select>
                </div>
