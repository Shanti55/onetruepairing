...
@section('content')
    ...
    <div class="px-3">
        <div class="d-flex align-items-center justify-content-between">
            <h5 class="fw-semibold">Payment Requests</h5>
        </div>
...
{{--            </div>--}}
            <div class="table-responsive">
                <table id="payment-requests-table" class="table">
                    <thead>
                    <tr>
                        <th>#</th>
                        <th>Date</th>
        ...
        @include('admin-panel.billings._partials._attachment')
    </div>
...
@push('js')
    <script type="module">
        $(function () {
            var table = $('#payment-requests-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('billing.payment-requests.index') }}",
                columns: [
