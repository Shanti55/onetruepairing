                ...
                <div class="container">
                    <div class="row gy-4 justify-content-between">
                        <div class="col-lg-4 order-lg-last">
                            <div class="card shadow-lg rounded-5">
                                ...
                                <div class="card-body p-0 p-md-3">
                                    <form method="POST" action="{{ route('service-providers.register') }}">
                                        @csrf
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="form-group mb-3">
                                                <label for="name" class="form-label"><b>Referral Code</b></label>
                                                <input type="text" name="referral_code" id="referral_code" placeholder="Enter Referral Code" class="rounded-4 form-control @error('referral_code') is-invalid @enderror"/>
                                                @error('referral_code')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                        ...
                        <div class="col-lg-6  d-flex flex-column justify-content-center" data-aos="fade-in">
                            ...
                            <div class="d-flex">
                                <a href="{{ route('service-providers.auth.login') }}" class="btn-get-started bg-white text-primary fw-bold">Already have an account ?</a>
                            </div>
                        </div>
