            ...
            <main class="main">
                <section id="featured-provider" class="team section light-background">
                    ...
                    <div class="container section-title text-center w-50" data-aos="fade-up">
                        <h1 class="fw-bold"><span class="description-title">{{ $setting->faqs_heading }}</span></h1>
                        <p class="text-wrap">{{ $setting->faqs_subheading }}</p>
